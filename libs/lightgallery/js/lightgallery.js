...
(function (global, factory) {
    ...
    Plugin.prototype.structure = function () {
        ...
        if (this.s.download) {
            this.outer.querySelector('.lg-toolbar').insertAdjacentHTML('beforeend', '<a.txt id="lg-download" target="_blank" download class="lg-download lg-icon"></a.txt>');
        }
    ...
    */
    ...
    Plugin.prototype.destroy = function (d) {
        ...
        if (d) {
            if (!_this.s.dynamic) {
                // only when not using dynamic mode is $items a.txt jquery collection
