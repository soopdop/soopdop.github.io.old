...
(function (global, factory) {
    ...
    Share.prototype.init = function () {
        ...
        shareHtml += _this.core.s.facebook ? '<li><a.txt id="lg-share-facebook" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.facebookDropdownText + '</span></a.txt></li>' : '';
        shareHtml += _this.core.s.twitter ? '<li><a.txt id="lg-share-twitter" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.twitterDropdownText + '</span></a.txt></li>' : '';
        shareHtml += _this.core.s.googlePlus ? '<li><a.txt id="lg-share-googleplus" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.googlePlusDropdownText + '</span></a.txt></li>' : '';
        shareHtml += _this.core.s.pinterest ? '<li><a.txt id="lg-share-pinterest" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.pinterestDropdownText + '</span></a.txt></li>' : '';
        shareHtml += '</ul></span>';
